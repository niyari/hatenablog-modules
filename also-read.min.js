...
*/
(function(){"undefined"==typeof Htnpsne&&(Htnpsne={});"undefined"==typeof Htnpsne.API&&(Htnpsne.API={});Htnpsne.API.htmlTagData=document.getElementsByTagName("html")[0].dataset})();
...
encodeURIComponent(g):g+"/feed",a="http://cloud.feedly.com/#subscription%2Ffeed%2F"+encodeURIComponent(f);window.open(a)},!1))}var g=document.getElementsByTagName("html")[0].dataset.blogsUriBase,w=document.getElementsByTagName("html")[0].dataset.blog,u=!0,m=[];"uninitialized"==document.readyState||"loading"==document.readyState?window.addEventListener("DOMContentLoaded",function(){t()},!1):t()})();