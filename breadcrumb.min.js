...
(function(){function g(){k=Htnpsne.API.htmlTagData;if("about"===k.page){var a,c;null==document.getElementById("Htnpsne-about-elem")&&(a=document.querySelector("div.entry-content"),c=document.createElement("dt"),c.innerText="\u30d6\u30ed\u30b0\u62e1\u5f35\u6a5f\u80fd",a.appendChild(c),c=document.createElement("dd"),c.id="Htnpsne-about-elem",a.appendChild(c));a=document.getElementById("Htnpsne-about-elem");c=document.createElement("div");c.innerHTML='<a href="http://psn.hatenablog.jp/entry/breadcrumb" target="_blank">\u30d1\u30f3\u304f\u305a\u30ea\u30b9\u30c8 \u3092\u5229\u7528\u4e2d\u3067\u3059\u3002</a>';
a.appendChild(c)}if("entry"===k.page){a=Htnpsne.Breadcrumb.q;window._parentCategory&&(console.log("Breadcrumb\uff1a\u53e4\u3044\u8a2d\u5b9a\u304c\u3042\u308a\u307e\u3059\u3002"),f());!1===a instanceof Array&&(a=[],window._parentCategory?a.push(["parentCategory",window._parentCategory]):a.push(["parentCategory",[]]));for(c=0;c<a.length;c++)try{switch(a[c][0]){case "parentCategory":l=a[c][1]}}catch(g){console.log("Queue Error \u2192"),console.log(g)}b=document.querySelector("header.entry-header div.categories");
if(!1!==b instanceof HTMLElement)if(a=b.querySelectorAll("a"),!1===a instanceof NodeList)console.log("\u30a8\u30f3\u30c8\u30ea\u306b\u30ab\u30c6\u30b4\u30ea\u304c\u3042\u308a\u307e\u305b\u3093\u3067\u3057\u305f");else{var d=l.join("<>")+"<>";c=[0];var h=0;if(0!==a.length)if(0===l.length)for(var e=0;e<a.length;e++)c[e]=0;else for(e=0;e<a.length;e++){if(-1<d.indexOf(a[e].innerHTML+"<>")||0===e)h=0;c[e]=h;h++}d=[];h=[];for(e=c.length-1;0<=e;e--)h.unshift({"@type":"ListItem",position:c[e]+1,item:{"@id":a[e].href,
name:a[e].innerText}}),0===c[e]&&(d.unshift({"@context":"http://schema.org","@type":"BreadcrumbList",itemListElement:h}),h=[]);a=document.createElement("script");a.type="application/ld+json";a.innerHTML=JSON.stringify(d);document.getElementsByTagName("head")[0].appendChild(a)}}else"archive"===k.page&&/^\/archive\/category\//.test(location.pathname)&&(c=document.querySelector("span.breadcrumb-child[itemtype='http://data-vocabulary.org/Breadcrumb']"))&&(a=c.querySelector("span[itemprop='title']"),d=
document.createElement("a"),d.setAttribute("itemprop","url"),d.setAttribute("href",location.href),d.appendChild(a),c.appendChild(d),c=location.href,a=a.innerText,d=document.createElement("script"),d.type="application/ld+json",d.innerHTML=JSON.stringify({"@context":"http://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,item:{"@id":c,name:a}}]}),document.getElementsByTagName("head")[0].appendChild(d))}function f(){Messenger.addEventListener("init",function(a){a.can_open_editor&&
...
document.getElementsByTagName("body")[0].appendChild(a))})}var k,l,b;"undefined"==typeof Htnpsne.Breadcrumb&&(Htnpsne.Breadcrumb={});Htnpsne.Breadcrumb.processed||(Htnpsne.Breadcrumb.processed=!0,"uninitialized"==document.readyState||"loading"==document.readyState?window.addEventListener("DOMContentLoaded",function(){g()},!1):g())})();